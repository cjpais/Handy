...
pub fn rdev_key_to_key(key: rdev::Key) -> Option<Key> {
    ...
    match key {
        ...
        RK::IntlBackslash => Some(Key::IntlBackslash),
        RK::IntlRo => Some(Key::IntlRo),
        RK::IntlYen => Some(Key::IntlYen),
        RK::KanaMode => Some(Key::KanaMode),
        RK::Lang1 => Some(Key::Lang1),
        RK::Lang2 => Some(Key::Lang2),
        RK::Lang3 => Some(Key::Lang3),
        RK::Lang4 => Some(Key::Lang4),
        RK::Lang5 => Some(Key::Lang5),
