...
pub fn keycode_to_key(keycode: CGKeyCode) -> Option<Key> {
    match keycode {
        ...
        keycodes::ISO_SECTION => Some(Key::IntlBackslash),
        keycodes::JIS_YEN => Some(Key::IntlYen),
        keycodes::JIS_UNDERSCORE => Some(Key::IntlRo),
        keycodes::JIS_EISU => Some(Key::Lang2),
        keycodes::JIS_KANA => Some(Key::Lang1),
        ...
        keycodes::JIS_KEYPAD_COMMA => Some(Key::IntlRo),
