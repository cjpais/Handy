...
mod vk {
    ...
    pub const OEM_8: u16 = 0xDF; // misc extra on some layouts
    pub const OEM_102: u16 = 0xE2; // <>| on many ISO keyboards
}
...
pub fn vk_to_key(vk_code: u16, is_extended: bool) -> Option<Key> {
    match vk_code {
        ...
        vk::OEM_8 => Some(Key::IntlYen),
        vk::OEM_102 => Some(Key::IntlBackslash),
