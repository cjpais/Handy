...
impl fmt::Display for Key {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Key::IntlRo => write!(f, "IntlRo"),
            Key::IntlYen => write!(f, "IntlYen"),
            Key::KanaMode => write!(f, "KanaMode"),
            Key::Lang1 => write!(f, "Lang1"),
            Key::Lang2 => write!(f, "Lang2"),
            Key::Lang3 => write!(f, "Lang3"),
            Key::Lang4 => write!(f, "Lang4"),
            Key::Lang5 => write!(f, "Lang5"),
...
impl FromStr for Key {
    ...
    fn from_str(s: &str) -> Result<Self> {
        ...
        match s.to_lowercase().as_str() {
            ...
            | "lessgreater"
            | "angle"
            | "intl_102" => Ok(Key::IntlBackslash),
            "intlro" | "intl_ro" | "ro" | "jis_underscore" | "underscore_jis" => {
                Ok(Key::IntlRo)
            }
            "intlyen" | "intl_yen" | "yen" | "jis_yen" | "backslash_jis" => {
                Ok(Key::IntlYen)
            }
            "kanamode"
            | "kana_mode"
            ...
            | "kanamodifier"
            | "hankaku_zenkaku"
            | "zenkaku_hankaku" => Ok(Key::KanaMode),
            "lang1" | "language1" | "hangul" | "kana_lang" => Ok(Key::Lang1),
            "lang2" | "language2" | "hanja" | "eisu" => Ok(Key::Lang2),
            "lang3" | "language3" | "katakana" => Ok(Key::Lang3),
            "lang4" | "language4" | "hiragana" => Ok(Key::Lang4),
            "lang5" | "language5" | "zenkaku" | "hankaku" => Ok(Key::Lang5),
