; Custom NSIS template for ThegAi with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\ThegAi for portable
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "ThegAi Portable Mode"
    FileClose $0
