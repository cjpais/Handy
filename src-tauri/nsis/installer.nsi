; Custom NSIS template for ixiwhisper with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\ixiwhisper for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older ixiwhisper releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "ixiwhisper Portable Mode"
    FileClose $0
