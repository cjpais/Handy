...
const DB_MIN: f32 = -70.0;   // Much more sensitive (was -55.0)
const DB_MAX: f32 = -8.0;
const GAIN: f32 = 3.2;       // x1.6 boost from user feedback (was 1.3)
const CURVE_POWER: f32 = 0.65; // Slightly more linear response (was 0.7)
