...
static MIGRATIONS: &[M] = &[
    ...
    // 'dictation' | 'command' — voice commands are recorded but never pasted.
    M::up("ALTER TABLE transcription_history ADD COLUMN entry_kind TEXT NOT NULL DEFAULT 'dictation';"),
];
    ...
    fn setup_conn() -> Connection {
        ...
        conn.execute_batch(
            "CREATE TABLE transcription_history (
                ...
                entry_kind TEXT NOT NULL DEFAULT 'dictation'
            );",
        )
