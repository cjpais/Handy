...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::change_parakeet_stream_att_context_right_setting,
            shortcut::change_parakeet_stream_buf_left_ms_setting,
            shortcut::change_parakeet_stream_buf_chunk_ms_setting,
            shortcut::change_parakeet_stream_buf_right_ms_setting,
