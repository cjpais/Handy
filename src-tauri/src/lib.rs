...
pub fn run() {
    ...
    let specta_builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        shortcut::change_search_enabled_setting,
        shortcut::change_search_base_url_setting,
        shortcut::change_search_api_key_setting,
        shortcut::change_search_model_setting,
        shortcut::set_search_provider,
        shortcut::fetch_search_models,
        shortcut::add_search_prompt,
        shortcut::update_search_prompt,
