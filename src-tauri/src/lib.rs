...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        shortcut::change_rewrite_base_url_setting,
        shortcut::change_rewrite_api_key_setting,
        shortcut::change_rewrite_model_setting,
        shortcut::set_rewrite_provider,
        shortcut::fetch_rewrite_models,
        shortcut::add_rewrite_prompt,
        shortcut::update_rewrite_prompt,
        shortcut::delete_rewrite_prompt,
        shortcut::set_rewrite_selected_prompt,
