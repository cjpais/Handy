...
This file provides guidance to Claude Code (claude.ai/code) when working with code in this repository. For deeper codebase context (stack, architecture, concerns, conventions), see [`.planning/codebase/`](.planning/codebase/README.md).
