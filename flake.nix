{
  description = "ThegAi - A speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          thegai = pkgs.rustPlatform.buildRustPackage {
            pname = "thegai";
            inherit version;
            src = self;
            ...
            meta = {
              description = "A speech-to-text application that works completely offline";
              homepage = "https://thegai.app";
          ...
          default = self.packages.${system}.thegai;
        }
      );
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.thegai.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.thegai;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.thegai.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.thegai;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "ThegAi development environment"
              bun install
