...
async setTranscriptionProvider(provider: TranscriptionProvider) : Promise<void> {
    await TAURI_INVOKE("set_transcription_provider", { provider });
},
async setSonioxApiKey(apiKey: string) : Promise<void> {
    await TAURI_INVOKE("set_soniox_api_key", { apiKey });
},
async setSonioxBaseUrl(baseUrl: string) : Promise<void> {
    await TAURI_INVOKE("set_soniox_base_url", { baseUrl });
},
async setSonioxModel(model: string) : Promise<void> {
    await TAURI_INVOKE("set_soniox_model", { model });
},
async setSonioxTimeoutSeconds(timeoutSeconds: number) : Promise<void> {
    await TAURI_INVOKE("set_soniox_timeout_seconds", { timeoutSeconds });
},
async setSonioxFallbackToLocal(fallbackToLocal: boolean) : Promise<void> {
    await TAURI_INVOKE("set_soniox_fallback_to_local", { fallbackToLocal });
},
async setSlngApiKey(apiKey: string) : Promise<void> {
    await TAURI_INVOKE("set_slng_api_key", { apiKey });
},
async setSlngEndpoint(endpoint: string) : Promise<void> {
    await TAURI_INVOKE("set_slng_endpoint", { endpoint });
},
async setSlngProvider(provider: string) : Promise<void> {
    await TAURI_INVOKE("set_slng_provider", { provider });
},
async setSlngModel(model: string) : Promise<void> {
    await TAURI_INVOKE("set_slng_model", { model });
},
async setSlngLanguage(language: string) : Promise<void> {
    await TAURI_INVOKE("set_slng_language", { language });
},
async setSlngTimeoutSeconds(timeoutSeconds: number) : Promise<void> {
    await TAURI_INVOKE("set_slng_timeout_seconds", { timeoutSeconds });
},
async setSlngFallbackToLocal(fallbackToLocal: boolean) : Promise<void> {
    await TAURI_INVOKE("set_slng_fallback_to_local", { fallbackToLocal });
},
...
export type TranscriptionProvider = "local" | "soniox" | "slng"
