...
async setTranscriptionMode(mode: string) : Promise<Result<null, string>> {
    try {
...
async setCloudTranscriptionProvider(providerId: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("set_cloud_transcription_provider", { providerId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async setCloudTranscriptionApiKey(providerId: string, apiKey: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("set_cloud_transcription_api_key", { providerId, apiKey }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async setCloudTranscriptionModel(providerId: string, model: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("set_cloud_transcription_model", { providerId, model }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async getCloudTranscriptionModels(providerId: string) : Promise<string[]> {
    return await TAURI_INVOKE("get_cloud_transcription_models", { providerId });
},
/**
