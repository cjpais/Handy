...
async getCustomSoundPaths() : Promise<CustomSoundPaths> {
    return await TAURI_INVOKE("get_custom_sound_paths");
},
async setCustomSoundPath(soundType: string, path: string | null) : Promise<Result<null, string>> {
    try {
