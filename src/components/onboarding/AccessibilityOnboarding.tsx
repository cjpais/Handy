...
const AccessibilityOnboarding: React.FC<AccessibilityOnboardingProps> = ({
  ...
  if (isChecking) {
    return (
      <div className="h-app w-full flex items-center justify-center">
  ...
  if (allGranted) {
    return (
      <div className="h-app w-full flex flex-col items-center justify-center gap-4">
  ...
  return (
    <div className="h-app w-full flex flex-col p-6 gap-6 items-center justify-center">
