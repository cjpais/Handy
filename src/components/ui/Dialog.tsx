...
export const Dialog: React.FC<DialogProps> = ({
  ...
  return createPortal(
    <div
      className="fixed inset-x-0 bottom-0 top-(--titlebar-height) z-50 flex items-center justify-center bg-black/50 p-4 sm:p-6"
    ...
    >
      <div
        ...
        tabIndex={-1}
        className={`flex max-h-[calc(100dvh-var(--titlebar-height)-2rem)] w-full max-w-lg flex-col overflow-hidden rounded-lg border border-mid-gray/20 bg-background shadow-xl outline-none sm:max-h-[calc(100dvh-var(--titlebar-height)-3rem)] ${className}`}
      >
