        ...
        <div className="max-w-2/3">
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {showTooltip && (
                <div className={`absolute ${tooltipPosition === "top" ? "bottom-full" : "top-6"} left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-background border border-mid-gray/80 rounded-lg shadow-lg z-50 max-w-xs min-w-[200px] whitespace-normal animate-in fade-in-0 zoom-in-95 duration-200`}>
                  <p className="text-sm text-center leading-relaxed">
                    {description}
                  </p>
                  <div className={`absolute ${tooltipPosition === "top" ? "top-full" : "bottom-21 rotate-180"} left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-[6px] border-r-[6px] border-t-[6px] border-l-transparent border-r-transparent border-t-mid-gray/80`}></div>
                </div>
              )}
            </div>
          </div>
