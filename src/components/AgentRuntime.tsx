  ...
  parameters: {
    ...
    properties: {
      ...
      stage: {
        type: "string",
        description:
          'Optional task stage/status filter. Omit for active, non-done tasks. Use a specific value like "To Do", "In Progress", or "Done"; use "all" only when the user explicitly asks to include every stage.',
      },
    },
    required: [],
    additionalProperties: false,
  ...
  parameters: {
    ...
    properties: {
      ...
      ownerName: {
        type: "string",
        description:
          "Deal relationship owner, only if the user explicitly names someone other than the local owner.",
      },
      nextStep: {
        type: "string",
        description: "Suggested next step.",
  ...
  parameters: {
    ...
    properties: {
      ...
      ownerName: {
        type: "string",
        description:
          "Person responsible for the task, if the user names someone other than the local owner.",
      },
      dueDate: {
        type: "string",
      ...
      status: {
        type: "string",
        description:
          'Current task stage/status, if stated. Examples: "To Do", "Doing", "Waiting for Response", "Done", "Blocked".',
      },
      relatedCompany: {
        type: "string",
      ...
      relatedDeal: {
        type: "string",
        description: "Related Notion deal/opportunity, if known.",
      },
      relatedEngagement: {
        type: "string",
        description: "Related Notion engagement, if known.",
      },
      relatedContact: {
        type: "string",
        description:
          "Related person or contact, if known. This is stored in the task description because the Tasks table has no contact relation.",
      },
      clientTaskType: {
        type: "string",
        description:
          'Client task type, if known. Examples: "Scheduling & Logistics", "Sales Follow Up", "Preparation", "Onboarding", "Operations".',
      },
      team: {
        type: "string",
        description: 'Team, if stated. Examples: "Revenue", "Leadership", "Ops".',
      },
      notes: {
        type: "string",
